...
Finally, the third assignment is an implementation of the \acrshort{slam} method \acrshort{ekf_slam}. This method is trying to both locate the robot and map the landmarks around it, by considering both range-bearing and odometry measurements. As the robot's movement and the relative position of the landmarks would logically be very correlated, this can be used to estimate both location and mapping. 
