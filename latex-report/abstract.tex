\begin{abstract} 
This report will highlight and discuss the results of the three graded assignments for the course TTK4250 Sensor Fusion. Several useful and fascinating methods for combining and analysing sensor data have been discussed in this course, with special emphasis on three specific applications: tracking, inertial navigation and \acrfull{slam}. The code implemented was tested and tuned for both simulated and real data sets. 
